...
namespace _Game
{
    public class Projectile : PoolableObject
    {
        ...
        protected virtual IEnumerator InitialInvulnerability()
        {
            ...
            _damageOnTouch.IgnoreGameObject(_skill.Owner.gameObject);
            yield return _initialInvulnerabilityDurationWFS;
            if (DamageOwner)
            {
                _damageOnTouch.StopIgnoringObject(_skill.Owner.gameObject);
            }
        }
        ...
        /// </summary>
        /// <param name="newSkill">New weapon.</param>
        public virtual void SetSkill(Skill newSkill)
        {
            _skill = newSkill;
        }
