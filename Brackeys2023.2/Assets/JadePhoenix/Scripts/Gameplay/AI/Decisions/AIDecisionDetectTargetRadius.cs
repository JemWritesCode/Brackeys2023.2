    ...
    public class AIDecisionDetectTargetRadius : AIDecision
    {
        ...
        protected virtual bool DetectTarget()
        {
            ...
            if (_hit.Length > 0)
            {
                ...
                RaycastHit hit = JP_Debug.Raycast3D(_raycastOrigin, _raycastDirection, Vector3.Distance(_hit[0].transform.position, _raycastOrigin), ObstacleMask.value, Color.yellow, true);
